...
- **One standalone binary, truly native.** The executable *is* the app: scanner, treemap engine, and a real native window (egui) in a single ~7 MB file. No installer, no Electron's 200 MB, no webview library. Copy it to any machine and run it.
